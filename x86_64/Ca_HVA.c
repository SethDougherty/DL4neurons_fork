...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_HVA /global/u2/s/sdough/Neuron_Latest_Pipeline/DL4neurons2/Neuron_Model_HH/mechanisms/Ca_HVA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/u2/s/sdough/Neuron_Latest_Pipeline/DL4neurons2/Neuron_Model_HH/mechanisms/Ca_HVA.mod";
static const char* nmodl_file_text = 
  ":Comment :\n"
