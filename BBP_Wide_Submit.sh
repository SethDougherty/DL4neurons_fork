...
csv_file="/global/homes/s/sdough/Neuron_Latest_Pipeline/DL4neurons2/testcell.csv"

# Define the second file path
second_file="/global/homes/s/sdough/Neuron_Latest_Pipeline/DL4neurons2/Params.csv"
i_cell=0
numsamples=100
count=1
